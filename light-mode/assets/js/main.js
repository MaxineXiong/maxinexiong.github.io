...
const projects = [
	...
	{ name: "Data Migration into CRM Apps", url: "./projects/rpa.html#rpa-data-entry", labels: ['UiPath RPA', 'Robotic Automation Process', 'UiPath Robot', 'UiPath Studio', 'RPA Workflow', 'Automation Processes', 'UiPath Classic Design', 'Web Application', 'Desktop Application',
																																															'parallel', 'data entry', 'data migration', 'dispatcher and performer bots with uipath orchestrator queues', 'UiPath Automation Cloud', 'transaction items', 'queue items'] },
