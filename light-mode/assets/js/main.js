...
const projects = [
	...
	{ name: "OpenAI API Applications", url: "./projects/ai-projects.html#openai-webapps", labels: ['python', 'web applications', 'GPT models', 'chatgpt', 'streamlit cloud', 'TTS model', 'whisper model', 'GPT-3.5 Turbo Model',
																																																 'GPT-4 Turbo Model', 'GPT-4o Model', 'omni', 'gpt-3.5-turbo', 'gpt-4-turbo', 'GPT 3.5', 'GPT 4', 'GPT3.5', 'GPT4', 'speech-to-text', 'text-to-speech',
	...
	{ name: "ChatGPT Tkinter Desktop App", url: "./projects/ai-projects.html#gpt-desktop", labels: ['ai', 'tkinter GUI', 'pyttsx3', 'python', 'desktop application', 'customtkinter', 'OpenAI API', 'GPT-3.5 Turbo Model',
																																																	'GPT-4 Turbo Model', 'GPT-4o Model', 'omni', 'gpt-3.5-turbo', 'gpt-4-turbo', 'GPT 3.5', 'GPT 4', 'GPT3.5', 'GPT4', 'text-to-speech',
																																																  'text to speech', 'voice output', 'text communication', 'chat completions API', 'text input', 'talk to gpt', 'chatbot'] },
