...
const projects = [
	...
	{ name: "Data Entry into CRM Apps", url: "./projects/rpa.html#rpa-data-entry", labels: ['UiPath RPA', 'Robotic Automation Process', 'UiPath Robot', 'UiPath Studio', 'RPA Workflow', 'Automation Processes', 'UiPath Classic Design', 'Web Application', 'Desktop Application', 'parallel'] },
